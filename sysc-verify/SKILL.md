...
인용 검증기는 세 가지를 본다: 인용 번호가 LRM에 실존하는가, LRM이 식별자로 이름 붙인 절을 인용해 놓고 문장은 형제 절의 식별자를 말하고 있지 않은가, `shall`/`should`/`error`를 뒷받침하는 인용이 규칙을 담은 절 대신 그 부모 절에서 멈추지 않았는가. 스킬 파일의 `§5.2.12`와 예제 소스의 `LRM 5.2.12`를 모두 센다.
